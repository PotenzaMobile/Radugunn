package com.radugunn.app.model;
...
public class CategoryList {
    ...
    //Todo: New Addition
    @SerializedName("advanced_qty_min")
    @Expose
    public String advancedQtyMin;

    @SerializedName("advanced_qty_max")
    @Expose
    public String advancedQtyMax = null;

    @SerializedName("advanced_qty_step")
    @Expose
    public String advancedQtyStep;

//    @SerializedName("advanced_qty_step-intervals")
//    @Expose
//    public String advancedQtyStepIntervals;

//    @SerializedName("advanced_qty_step-intervals")
//    @Expose
//    private List<List<String>> advancedQtyStepIntervals = null;
//
//    @SerializedName("advanced_qty_value")
//    @Expose
//    public String advancedQtyValue;
//    @SerializedName("advanced_qty_price-suffix")
//    @Expose
//    public String advancedQtyPriceSuffix;
//    @SerializedName("advanced_qty_quantity-suffix")
//    @Expose
//    public String advancedQtyQuantitySuffix;
//    @SerializedName("advanced_qty_price-factor")
//    @Expose
//    public String advancedQtyPriceFactor;
//    @SerializedName("advanced_qty_input-picker")
//    @Expose
//    public String advancedQtyInputPicker;

    public String getAdvancedQtyMin() {
        return advancedQtyMin;
    }

    public void setAdvancedQtyMin(String advancedQtyMin) {
        this.advancedQtyMin = advancedQtyMin;
    }

    public String getAdvancedQtyMax() {
        return advancedQtyMax;
    }

    public void setAdvancedQtyMax(String advancedQtyMax) {
        this.advancedQtyMax = advancedQtyMax;
    }

    public String getAdvancedQtyStep() {
        return advancedQtyStep;
    }

    public void setAdvancedQtyStep(String advancedQtyStep) {
