...
import com.radugunn.app.model.Orders;
import com.radugunn.app.model.Sort;
...
public class Constant {
    ...
    public static final String MyPREFERENCES = "com.radugunn.app"; // Add your package name

    public static final String PACKAGE_NAME = "com.radugunn.app";  // Add your package name

    public static final String DeepLinkDomain = "example.page.link";// Add your Deeplink Domain URL

    public static final String DynamicLinkIosParameters = "com.radugunn.app"; // Add your Deeplink IOS package name if you have
    ...
    public static final String CIYASHOP_ = "RadugaNN";
    public static final String CIYASHOP_CODE = "RadugaNN";
    ...
    public static String SECONDARY_COLOR = "#23a455";
