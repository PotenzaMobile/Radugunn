package com.radugunn.app.customview.like.animation;
...
public class SparkButton extends FrameLayout implements View.OnClickListener {
    ...
    void init() {
        ...
        circleView.setColors(Color.parseColor(Constant.SECONDARY_COLOR), Color.parseColor(Constant.SECONDARY_COLOR));
      //  circleView.setColors(Color.parseColor(((BaseActivity) getContext()).getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)), Color.parseColor(((BaseActivity) getContext()).getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        ...
        dotsView.setColors(Color.parseColor(Constant.SECONDARY_COLOR), Color.parseColor(Constant.SECONDARY_COLOR));
