...
import com.radugunn.app.model.Notify;
...
//                        getPreferences().edit().putString("notified", "no").commit();
                ...
                dismissProgress();
                Log.e(TAG, "onResponse: post:  "+"dismiss"  );
            }
            ...
            if (response != null && response.length() > 0) {
                ...
                dismissProgress();
                Log.e(TAG, "onResponse: get Product:  "+"dismiss"  );
            }
            ...
            if (response != null && response.length() > 0) {
                ...
                dismissProgress();
                Log.e(TAG, "onResponse: Infinite scroll:  "+"dismiss"  );
            }
