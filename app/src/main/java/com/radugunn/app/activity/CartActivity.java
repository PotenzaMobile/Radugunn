...
import com.radugunn.app.adapter.CartAdapter;
        ...
        if (cartList.size() > 0) {
            ...
            try {
                ...
                for (int i = 0; i < cartList.size(); i++) {
                    ...
                    Log.e(TAG, "getCartDataForAPI: " + note);

                    JSONObject object1 = new JSONObject();
                    if (cartList.get(i).getNote() != null) {
                        object1.put(RequestParamUtils.ProductComments, cartList.get(i).getNote());
                        Log.e(TAG, "getCartDataForAPI: " + object1);
                        Log.e(TAG, "getCartDataForAPI: " + cartList.get(i).getNote());
                    }

                    object.put(RequestParamUtils.CartItemData, object1);
